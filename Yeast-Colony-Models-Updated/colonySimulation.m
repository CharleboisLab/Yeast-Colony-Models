function [cellCount,mutantCount,subColonyCount,cellsnoList,time,lattices] = colonySimulation(NUTRIENT_STEPS,endConditions,latticeSize,lattices,AGAR_WEIGHT,magnet,UNIPOLAR_ON,displaySettings)
...
% AGAR_WEIGHT is a number representing the agar concentration
%   note: agar concentration effects are turned off, see updateBudProb
%         method of YeastCell object
...
while whileCondition  
    ...
    while ~aliveCellChosen
        ...
        if lattices.('states')(i_r,j_r) == 1
            ...
            lattices = updateYeastCell(lattices,i_r,j_r,AGAR_WEIGHT,UNIPOLAR_ON);
            if liveNeighbours < 8
