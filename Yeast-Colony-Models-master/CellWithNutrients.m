...
classdef CellWithNutrients
    ...
    properties
        ...
        normalFrac = 0.8   % indicates the fraction of the time the cell will bud regularly.
        deltaNormalFrac = 0.125   % indicates by how much unipolarFrac will change as the number of nutrient packets changes.
    ...
    methods
        ...
        function obj = CellWithNutrients(state,budScar,nutrientConcentration,deltaNormalFrac)
           % class constructor
             obj.state = state;
             obj.budScar = budScar;
             obj.nutrientConcentration = nutrientConcentration;
             obj.deltaNormalFrac = deltaNormalFrac;
        end
        ...
        function obj = updateNormalFrac(obj)
            % updateUnipolarFrac updates unipolarFrac based on
            % nutrientConcentration
            obj.normalFrac = obj.deltaNormalFrac * obj.nutrientConcentration;
        end
