...
% Loops through all necessary parameters. Could take up to 24 hours. Can be
% broken up by shortening arrays to only some of the parameters and running
% the loop multiple times with the different parameters.
